...
class ArtifactSourcePOSTInput:
    ...
    Attributes:
        ...
        secret_files (Union[Unset, list['SecretFileInput']]): Secret files for the artifact source's build. Only valid
            for `git` sources.
        env_group_ids (Union[Unset, list[str]]): IDs of env groups to link to the artifact source. Only valid for `git`
