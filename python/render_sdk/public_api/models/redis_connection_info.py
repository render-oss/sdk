...
T = TypeVar("T", bound="RedisConnectionInfo")
...
class RedisConnectionInfo:
    ...
    Attributes:
        ...
        redis_cli_command (str): The Redis CLI command to connect to the Redis instance
    """
        ...
        field_dict.update(
            {
                ...
                "redisCLICommand": redis_cli_command,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        redis_cli_command = d.pop("redisCLICommand")

        redis_connection_info = cls(
            internal_connection_string=internal_connection_string,
            external_connection_string=external_connection_string,
            redis_cli_command=redis_cli_command,
        )

        redis_connection_info.additional_properties = d
