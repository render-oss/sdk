...
T = TypeVar("T", bound="NotificationServiceOverride")


@_attrs_define
class NotificationServiceOverride:
    """
    Attributes:
        service_id (str):
