...
T = TypeVar("T", bound="ArtifactSourceGit")
...
class ArtifactSourceGit:
    ...
    Attributes:
        ...
        region (Union[Unset, ArtifactSourceGitRegion]): Defaults to "oregon" Default: ArtifactSourceGitRegion.OREGON.
    ...
    region: Union[Unset, ArtifactSourceGitRegion] = ArtifactSourceGitRegion.OREGON
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        region: Union[Unset, ArtifactSourceGitRegion]
        if isinstance(_region, Unset):
            region = UNSET
        else:
            region = ArtifactSourceGitRegion(_region)

        repo_url = d.pop("repoUrl", UNSET)

        root_dir = d.pop("rootDir", UNSET)

        artifact_source_git = cls(
            runtime=runtime,
            base_dir=base_dir,
            branch=branch,
        ...
        artifact_source_git.additional_properties = d
        return artifact_source_git
