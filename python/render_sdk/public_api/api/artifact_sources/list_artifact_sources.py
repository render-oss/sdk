...
from ...models.artifact_source_with_cursor import ArtifactSourceWithCursor
...
) -> Optional[Union[Error, list["ArtifactSourceWithCursor"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ArtifactSourceWithCursor.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, list["ArtifactSourceWithCursor"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Error, list['ArtifactSourceWithCursor']]
    """
