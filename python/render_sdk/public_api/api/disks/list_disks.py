...
from ...models.disk_with_cursor import DiskWithCursor
...
def _get_kwargs(
    *,
    ...
    disk_id: Union[Unset, list[str]] = UNSET,
    ...
    json_disk_id: Union[Unset, list[str]] = UNSET
    if not isinstance(disk_id, Unset):
        json_disk_id = disk_id

    params["diskId"] = json_disk_id
...
) -> Optional[Union[Error, list["DiskWithCursor"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = DiskWithCursor.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, list["DiskWithCursor"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List disks
     ...
     List persistent disks matching the provided filters. If no filters are provided, returns all disks
    you have permissions to view.

    Args:
        owner_id (Union[Unset, list[str]]):
        disk_id (Union[Unset, list[str]]):
...
def sync(
    *,
    ...
    Returns:
        Union[Error, list['DiskWithCursor']]
    """
