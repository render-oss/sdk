...
from ...models.list_logs_response_200 import ListLogsResponse200
...
) -> Optional[Union[Error, ListLogsResponse200]]:
    if response.status_code == 200:
        response_200 = ListLogsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, ListLogsResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Error, ListLogsResponse200]
    """
