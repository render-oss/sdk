...
) -> Optional[Union[Error, Log]]:
    if response.status_code == 101:
        response_101 = Log.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Subscribe to new logs
     ...
     Open a websocket connection to subscribe to logs matching the provided filters. Logs are streamed in
