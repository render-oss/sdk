...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/metrics/filters/application",
        "params": params,
    }
...
) -> Optional[Union[Error, list["FilterApplicationValuesCollectionItem"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, list["FilterApplicationValuesCollectionItem"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Error, list['FilterApplicationValuesCollectionItem']]
    """
