...
T = TypeVar("T", bound="NotificationServiceOverridePATCH")


@_attrs_define
class NotificationServiceOverridePATCH:
    """
    Attributes:
        preview_notifications_enabled (Union[Unset, NotifyPreviewOverride]):
        notifications_to_send (Union[Unset, NotifyOverride]):
    """

    preview_notifications_enabled: Union[Unset, NotifyPreviewOverride] = UNSET
    notifications_to_send: Union[Unset, NotifyOverride] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_notifications_to_send, Unset):
            ...
            notifications_to_send = NotifyOverride(_notifications_to_send)

        notification_service_override_patch = cls(
            preview_notifications_enabled=preview_notifications_enabled,
            notifications_to_send=notifications_to_send,
        )

        notification_service_override_patch.additional_properties = d
        return notification_service_override_patch
