...
from ...models.update_workspace_member_body import UpdateWorkspaceMemberBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/owners/{owner_id}/members/{user_id}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        owner_id (str):
        user_id (str):  Example: usr-5k6m7n8p9q0r1s2t3u4v.
        body (UpdateWorkspaceMemberBody):
