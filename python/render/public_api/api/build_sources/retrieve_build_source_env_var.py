...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/build-sources/{build_source_id}/env-vars/{env_var_key}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    This only applies to environment variables set directly on the build source, not to environment
