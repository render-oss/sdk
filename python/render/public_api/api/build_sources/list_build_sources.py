...
from ...models.build_source_with_cursor import BuildSourceWithCursor
...
) -> Optional[Union[Error, list["BuildSourceWithCursor"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = BuildSourceWithCursor.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, list["BuildSourceWithCursor"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Error, list['BuildSourceWithCursor']]
    """
