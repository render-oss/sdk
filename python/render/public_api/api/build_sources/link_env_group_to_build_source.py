...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/build-sources/{build_source_id}/env-groups/{env_group_id}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    The build source will have access to the environment variables and secret files in the group at
    build time.
