...
from ...models.get_http_requests_aggregate_by import GetHttpRequestsAggregateBy
...
def _get_kwargs(
    *,
    ...
    aggregate_by: Union[Unset, GetHttpRequestsAggregateBy] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        aggregate_by (Union[Unset, GetHttpRequestsAggregateBy]):
