...
T = TypeVar("T", bound="UpdateRegistryCredentialBody")
...
class UpdateRegistryCredentialBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_registry_credential_body = cls(
            registry=registry,
            name=name,
            username=username,
        ...
        update_registry_credential_body.additional_properties = d
        return update_registry_credential_body
