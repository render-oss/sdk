...
T = TypeVar("T", bound="PrivateServiceDetailsPOST")
...
class PrivateServiceDetailsPOST:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        private_service_details_post = cls(
            runtime=runtime,
        ...
        private_service_details_post.additional_properties = d
        return private_service_details_post
