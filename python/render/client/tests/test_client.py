...
from render.client.render_public_api_client.models.task_run_details import TaskRunDetails
...
def client(mocker, mock_authenticated_client):
    ...
    mocker.patch('render.client.client.AuthenticatedClient', return_value=mock_authenticated_client)
