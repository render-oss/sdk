...
def mock_cancel_task_run_asyncio(mocker):
    return mocker.patch(
        "render.public_api.api.workflow_tasks.cancel_task_run.asyncio_detailed"
    )
...
def mock_list_task_runs_asyncio(mocker):
    return mocker.patch(
        "render.public_api.api.workflow_tasks.list_task_runs.asyncio_detailed"
    )
...
def mock_create_task_asyncio(mocker):
    return mocker.patch(
        "render.public_api.api.workflow_tasks.create_task.asyncio_detailed"
    )
...
def mock_get_task_run_asyncio(mocker):
    return mocker.patch(
        "render.public_api.api.workflow_tasks.get_task_run.asyncio_detailed"
    )
