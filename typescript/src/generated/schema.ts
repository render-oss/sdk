...
export interface paths {
    ...
    "/dedicated-ips": {
        ...
        /**
         * List dedicated IPs
         * @description List dedicated IP sets for a workspace.
         */
        get: operations["list-dedicated-ips"];
        put?: never;
        /**
         * Create dedicated IP set
         * @description Create a dedicated IP set. Provisioning an IP set is asynchronous. The response returns immediately with `status: CREATING` and `ips: []`. When provisioning completes, status changes to `RUNNING` and `ips` contains your assigned addresses.
         *
         ...
         */
        post: operations["create-dedicated-ip"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/dedicated-ips/{dedicatedIpId}": {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description The ID of the dedicated IP set */
         ...
         * @description Retrieve the dedicated IP set with the provided ID.
         */
        get: operations["retrieve-dedicated-ip"];
        put?: never;
        post?: never;
        /**
         * Delete dedicated IP set
         * @description Delete the dedicated IP set with the provided ID.
         */
        delete: operations["delete-dedicated-ip"];
        options?: never;
        head?: never;
        /**
         * Update dedicated IP set
         * @description Update the dedicated IP set with the provided ID. All fields are optional. Omitted fields are left unchanged. To switch from environment-scoped to workspace-scoped, provide `environmentIds: []`.
         */
        patch: operations["update-dedicated-ip"];
        trace?: never;
    };
    "/disks": {
        parameters: {
    ...
    "/key-value/{keyValueId}": {
         ...
         * @description Update a Key Value instance by ID. Note that changing your plan, max memory policy, or persistence mode will restart your Key Value instance.
         */
    ...
    "/key-value/{keyValueId}/suspend": {
         ...
         */
        post: operations["suspend-key-value"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/key-value/{keyValueId}/resume": {
         ...
         */
        post: operations["resume-key-value"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/postgres/{postgresId}/credentials": {
         ...
         */
        get: operations["list-postgres-users"];
        put?: never;
        /**
         ...
         */
        post: operations["create-postgres-user"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/postgres/{postgresId}/credentials/{username}": {
         ...
         */
        delete: operations["delete-postgres-user"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/sandboxes/{sandboxId}/terminate": {
        ...
        /**
         * Terminate sandbox
         * @description Terminate the sandbox with the provided ID. Idempotent: returns 204 from any
    ...
    "/sandboxes/{sandboxId}/logs": {
         ...
         * @description Stream sandbox output and lifecycle events as a server-sent event stream.
         ...
         *     lifecycle event.
         */
        get: operations["stream-sandbox-logs"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/sandboxes/{sandboxId}/files/list": {
        parameters: {
            query: {
                /**
                 * @description Absolute path to a directory in the sandbox.
                 * @example /app
                 */
                path: string;
                /** @description How many levels of subdirectories to include. 1 = immediate children only. 0 = the entry itself. */
                depth?: number;
            };
            header?: never;
            path: {
         ...
         * @description List the contents of a directory in a running sandbox. Returns file and
         *     directory metadata without transferring file contents. The sandbox must
         *     be `running`.
         */
        get: operations["list-sandbox-files"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * @description Current status of a dedicated IP set.
         * @enum {string}
         */
        dedicatedIPStatus: "UNKNOWN" | "CREATING" | "PENDING" | "RUNNING" | "FAILED" | "DELETING" | "DELETED";
        dedicatedIP: {
            /** @description Unique identifier for this dedicated IP set. */
            id: string;
            /** @description Descriptive name for this dedicated IP set. */
            name: string;
            /** @description Free-form description for this dedicated IP set. */
            description: string;
            /** @description The ID of the workspace that owns this dedicated IP set. */
            ownerId: string;
            region: components["schemas"]["region"];
            /** @description Environments this dedicated IP set applies to. If empty, it applies to all services in the workspace within its region. */
            environmentIds: string[];
            /** @description The IPv4 addresses assigned to this dedicated IP set. */
            ips: string[];
            status: components["schemas"]["dedicatedIPStatus"];
            /**
             * Format: date-time
             * @description Time the dedicated IP set was created.
             */
            createdAt: string;
            /**
             * Format: date-time
             * @description Time the dedicated IP set was last updated.
             */
            updatedAt?: string;
        };
        /** @description Input for creating a dedicated IP set. */
        dedicatedIPPOST: {
            /** @description Name for the dedicated IP set. */
            name: string;
            /** @description Free-form description for the dedicated IP set. */
            description?: string;
            /** @description The ID of the workspace that will own this dedicated IP set. */
            ownerId: string;
            region: components["schemas"]["region"];
            /** @description Environments to scope the dedicated IP set to. If omitted or empty, it applies to all services in the workspace within its region. */
            environmentIds?: string[];
        };
        /** @description Input for updating a dedicated IP set. All fields are optional. Omitted fields are left unchanged. Provide `environmentIds: []` to switch from environment-scoped to workspace-scoped. */
        dedicatedIPPATCH: {
            name?: string;
            description?: string;
            environmentIds?: string[];
        ...
        /**
         * @description How requests from other services in the same workspace are routed to this service's instances. When unset, Render's standard routing is used. `ipOnly` routes requests directly to individual instance IPs. Only available to workspaces that Render has granted access. Can only be set when creating a service.
         * @enum {string}
         */
        internalRouting: "ipOnly";
        webServiceDetails: {
        ...
        cache: {
             ...
             * @enum {string}
             */
            profile: "no-cache" | "origin-controlled" | "origin-controlled-all";
        };
        diskWithCursor: {
         ...
         * @enum {string}
         */
        teamMemberRole: "ADMIN" | "DEVELOPER" | "WORKSPACE_CONTRIBUTOR" | "WORKSPACE_BILLING" | "WORKSPACE_VIEWER";
        ownerWithCursor: {
        ...
        /**
         * @description The persistence mode for the Key Value instance. The default for paid instances is journal_snapshot (both journaling and snapshots). Only turn off persistence if you're using this Key Value instance as a cache and are okay with losing data. Free instances do not have persistence.
         * @enum {string}
         */
        ...
        postgresPOSTInput: {
            ...
            /**
             * @description What connection pool to use (if any) out of 'pgbouncer' and 'none'
             * @default none
             */
         ...
         * @enum {string}
         */
        postgresVersion: "11" | "12" | "13" | "14" | "15" | "16" | "17" | "18";
        /** @enum {string} */
        ...
        envVarKeyGenerateValue: {
            key: string;
            /** @description If true, Render generates a strong random value for this environment variable on creation. Cannot be combined with `value`. */
            generateValue: boolean;
        };
        ...
        failureReason: {
            evicted: boolean;
            /** @description Details about why the application was evicted. */
        ...
        autoDeployDisabledEvent: {
            /** @description Why auto-deploy was disabled (manual_deploy, rollback, or setting_change) */
            reason: string;
            /** @description The auto-deploy trigger value immediately before it was disabled */
            fromTrigger?: components["schemas"]["autoDeployTrigger"];
        };
        /** Auto Deploy Enabled */
        autoDeployEnabledEvent: {
            /** @description The auto-deploy trigger value after it was re-enabled */
        ...
        /** Postgres Connection Pool Changed */
        postgresConnectionPoolChangedEvent: {
            user?: components["schemas"]["schemas-user"];
            from: string;
            to: string;
        };
        /** Postgres Connection Pool Enabled Changed */
        postgresConnectionPoolEnabledChangedEvent: {
            user?: components["schemas"]["schemas-user"];
            enabled: boolean;
        };
        /** Postgres Created */
        ...
        postgresEventDetails: components["schemas"]["postgresAvailableEvent"] | components["schemas"]["postgresBackupCompletedEvent"] | components["schemas"]["postgresBackupFailedEvent"] | components["schemas"]["postgresBackupStartedEvent"] | components["schemas"]["postgresClusterLeaderChangedEvent"] | components["schemas"]["postgresConnectionPoolChangedEvent"] | components["schemas"]["postgresConnectionPoolEnabledChangedEvent"] | components["schemas"]["postgresCreatedEvent"] | components["schemas"]["postgresDiskSizeChangedEvent"] | components["schemas"]["postgresHaStatusChangedEvent"] | components["schemas"]["postgresReadReplicasChangedEvent"] | components["schemas"]["postgresRestartedEvent"] | components["schemas"]["postgresUnavailableEvent"] | components["schemas"]["postgresUpgradeFailedEvent"] | components["schemas"]["postgresUpgradeStartedEvent"] | components["schemas"]["postgresUpgradeSucceededEvent"] | components["schemas"]["postgresPITRCheckpointStartedEvent"] | components["schemas"]["postgresPITRCheckpointFailedEvent"] | components["schemas"]["postgresPITRCheckpointCompletedEvent"] | components["schemas"]["postgresReadReplicaStale"];
        /** Key Value Available */
         ...
         * @enum {string}
         */
        otelProviderType: "BETTER_STACK" | "GRAFANA" | "DATADOG" | "NEW_RELIC" | "HONEYCOMB" | "SIGNOZ" | "GROUNDCOVER" | "LOGFIRE" | "CUSTOM";
        metricsStream: {
            /** @description The ID of the owner */
            ownerId: string;
        ...
        TaskAttemptDetails: {
            ...
            /** Format: date-time */
            completedAt?: string;
            /** @description Error message if the task attempt failed. */
            error?: string;
        ...
        getObjectOutput: {
            ...
            /**
             * Format: date-time
             * @description The time at which the presigned URL expires (ISO 8601 format)
        ...
        sandboxFileEntry: {
            /**
             * @description File or directory name (basename, not full path).
             * @example main.py
             */
            name: string;
            /**
            ...
            /**
             * @description Size in bytes. 0 for directories and symlinks.
             * @example 2048
             */
            size: number;
            /**
             ...
             */
            modifiedAt: string;
            /** @description Symlink target path. Present only when type is `symlink`. */
            target?: string;
        };
        ...
        sandboxDirectoryListing: {
             ...
             */
            path: string;
            entries: components["schemas"]["sandboxFileEntry"][];
        };
    };
    responses: {
    ...
    parameters: {
        ...
        /** @description The region to return resources for */
        regionPathParam: components["schemas"]["region"];
        /** @description The ID of the user (Render object ID with a `usr-` prefix). */
...
export interface operations {
    ...
    "list-dedicated-ips": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["dedicatedIP"][];
                };
            };
            400: components["responses"]["400BadRequest"];
            401: components["responses"]["401Unauthorized"];
    ...
    "create-dedicated-ip": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["dedicatedIPPOST"];
            };
        };
        responses: {
            /** @description Created */
    ...
    "delete-dedicated-ip": {
        ...
        requestBody?: never;
        responses: {
            /** @description Dedicated IP deleted */
            204: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    "update-dedicated-ip": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["dedicatedIPPATCH"];
            };
        };
        responses: {
            /** @description OK */
    ...
    "create-ephemeral-shell": {
        ...
        requestBody?: {
            content: {
                "application/json": {
                    /** @description The plan to use when creating the ephemeral shell instance. */
                    plan?: string;
                    /**
                     * @deprecated
                     * @description The size to use when creating the ephemeral shell instance.
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": {
                        /**
                         * @description The unique identifier of the ephemeral shell.
                         * @example shl-123456789
                         */
                        id?: string;
                    };
                };
    ...
    "create-postgres-user": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["credentialCreateInput"];
            };
        };
        responses: {
    ...
    "create-sandbox": {
        ...
        responses: {
            /** @description Sandbox created. Returns the initial sandbox snapshot. */
            201: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    "stream-sandbox-logs": {
        parameters: {
            query?: {
                /** @description ISO 8601 timestamp. Only emit events at or after this time. */
                since?: string;
                /** @description If `false`, emit historical events and close immediately. */
                follow?: boolean;
                /** @description Filter `log` events to a single execution. */
                execId?: string;
            };
            header?: {
                /** @description Must be `text/event-stream`. */
        ...
        requestBody?: never;
        responses: {
            /** @description Event stream established. Emits `log` and `lifecycle` events. */
            200: {
                headers: {
                    /** @description Always `text/event-stream; charset=utf-8` */
                    "Content-Type"?: string;
    ...
    "list-sandbox-files": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["sandboxDirectoryListing"];
                };
            };
            400: components["responses"]["400BadRequest"];
            401: components["responses"]["401Unauthorized"];
