...
const (
	NotifySettingV2All     NotifySettingV2 = "all"
	NotifySettingV2Failure NotifySettingV2 = "failure"
	NotifySettingV2None    NotifySettingV2 = "none"
)

// Valid indicates whether the value is a known member of the NotifySettingV2 enum.
func (e NotifySettingV2) Valid() bool {
	switch e {
	case NotifySettingV2All:
		return true
	case NotifySettingV2Failure:
		return true
	case NotifySettingV2None:
		return true
	default:
		return false
	}
