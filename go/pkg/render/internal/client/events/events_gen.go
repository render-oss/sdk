...
type Event struct {
	...
	// Id Example: evt-cph1rs3idesc73a2b2mg
	Id        EventId                `json:"id"`
...
// EventId Example: evt-cph1rs3idesc73a2b2mg
type EventId = string
...
// InstanceId Example: srv-d0cjkelq67qs70c2pugg-sbpkm
...
// PostgresConnectionPoolChangedEvent defines model for postgresConnectionPoolChangedEvent.
type PostgresConnectionPoolChangedEvent struct {
	From string `json:"from"`
	To   string `json:"to"`
...
// PostgresConnectionPoolEnabledChangedEvent defines model for postgresConnectionPoolEnabledChangedEvent.
type PostgresConnectionPoolEnabledChangedEvent struct {
	Enabled bool `json:"enabled"`
...
// AsPostgresConnectionPoolChangedEvent returns the union data inside the PostgresEventDetails as a PostgresConnectionPoolChangedEvent
func (t PostgresEventDetails) AsPostgresConnectionPoolChangedEvent() (PostgresConnectionPoolChangedEvent, error) {
	var body PostgresConnectionPoolChangedEvent
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPostgresConnectionPoolChangedEvent overwrites any union data inside the PostgresEventDetails as the provided PostgresConnectionPoolChangedEvent
func (t *PostgresEventDetails) FromPostgresConnectionPoolChangedEvent(v PostgresConnectionPoolChangedEvent) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergePostgresConnectionPoolChangedEvent performs a merge with any union data inside the PostgresEventDetails, using the provided PostgresConnectionPoolChangedEvent
func (t *PostgresEventDetails) MergePostgresConnectionPoolChangedEvent(v PostgresConnectionPoolChangedEvent) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsPostgresConnectionPoolEnabledChangedEvent returns the union data inside the PostgresEventDetails as a PostgresConnectionPoolEnabledChangedEvent
func (t PostgresEventDetails) AsPostgresConnectionPoolEnabledChangedEvent() (PostgresConnectionPoolEnabledChangedEvent, error) {
	var body PostgresConnectionPoolEnabledChangedEvent
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPostgresConnectionPoolEnabledChangedEvent overwrites any union data inside the PostgresEventDetails as the provided PostgresConnectionPoolEnabledChangedEvent
func (t *PostgresEventDetails) FromPostgresConnectionPoolEnabledChangedEvent(v PostgresConnectionPoolEnabledChangedEvent) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergePostgresConnectionPoolEnabledChangedEvent performs a merge with any union data inside the PostgresEventDetails, using the provided PostgresConnectionPoolEnabledChangedEvent
func (t *PostgresEventDetails) MergePostgresConnectionPoolEnabledChangedEvent(v PostgresConnectionPoolEnabledChangedEvent) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsArtifactFetchFailedEvent returns the union data inside the ServiceEventDetails as a ArtifactFetchFailedEvent
func (t ServiceEventDetails) AsArtifactFetchFailedEvent() (ArtifactFetchFailedEvent, error) {
	var body ArtifactFetchFailedEvent
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromArtifactFetchFailedEvent overwrites any union data inside the ServiceEventDetails as the provided ArtifactFetchFailedEvent
func (t *ServiceEventDetails) FromArtifactFetchFailedEvent(v ArtifactFetchFailedEvent) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeArtifactFetchFailedEvent performs a merge with any union data inside the ServiceEventDetails, using the provided ArtifactFetchFailedEvent
func (t *ServiceEventDetails) MergeArtifactFetchFailedEvent(v ArtifactFetchFailedEvent) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsArtifactSourceChangedEvent returns the union data inside the ServiceEventDetails as a ArtifactSourceChangedEvent
func (t ServiceEventDetails) AsArtifactSourceChangedEvent() (ArtifactSourceChangedEvent, error) {
	var body ArtifactSourceChangedEvent
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromArtifactSourceChangedEvent overwrites any union data inside the ServiceEventDetails as the provided ArtifactSourceChangedEvent
func (t *ServiceEventDetails) FromArtifactSourceChangedEvent(v ArtifactSourceChangedEvent) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeArtifactSourceChangedEvent performs a merge with any union data inside the ServiceEventDetails, using the provided ArtifactSourceChangedEvent
func (t *ServiceEventDetails) MergeArtifactSourceChangedEvent(v ArtifactSourceChangedEvent) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
