...
const (
	JournalSnapshot PersistenceMode = "journal_snapshot"
...
type UpdateSecretFilesForArtifactSourceJSONBody = []SecretFileInput
...
type ExecSandboxSyncJSONRequestBody = externalRef15.SandboxExecSyncRequest
