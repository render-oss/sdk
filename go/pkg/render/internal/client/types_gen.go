...
import (
	...
	externalRef2 "github.com/render-oss/sdk/go/pkg/render/internal/client/blueprints"
	externalRef3 "github.com/render-oss/sdk/go/pkg/render/internal/client/buildsources"
	...
	externalRef6 "github.com/render-oss/sdk/go/pkg/render/internal/client/events"
	externalRef8 "github.com/render-oss/sdk/go/pkg/render/internal/client/eventtypes"
	externalRef9 "github.com/render-oss/sdk/go/pkg/render/internal/client/jobs"
	externalRef10 "github.com/render-oss/sdk/go/pkg/render/internal/client/logs"
	externalRef11 "github.com/render-oss/sdk/go/pkg/render/internal/client/maintenance"
	externalRef12 "github.com/render-oss/sdk/go/pkg/render/internal/client/metrics"
	externalRef13 "github.com/render-oss/sdk/go/pkg/render/internal/client/notifications"
	externalRef14 "github.com/render-oss/sdk/go/pkg/render/internal/client/postgres"
	externalRef15 "github.com/render-oss/sdk/go/pkg/render/internal/client/sandboxes"
	externalRef16 "github.com/render-oss/sdk/go/pkg/render/internal/client/storage"
	externalRef17 "github.com/render-oss/sdk/go/pkg/render/internal/client/webhooks"
	externalRef18 "github.com/render-oss/sdk/go/pkg/render/internal/client/workflows"
)

// Defines values for DeployMode.
const (
	BuildAndDeploy DeployMode = "build_and_deploy"
	DeployOnly     DeployMode = "deploy_only"
)

// Valid indicates whether the value is a known member of the DeployMode enum.
func (e DeployMode) Valid() bool {
	switch e {
	case BuildAndDeploy:
		return true
	case DeployOnly:
...
// Defines values for AuditLogEvent.
const (
	AcceptOrgInviteEvent               AuditLogEvent = "AcceptOrgInviteEvent"
	AcceptTeamInviteEvent              AuditLogEvent = "AcceptTeamInviteEvent"
	AddOrgMemberEvent                  AuditLogEvent = "AddOrgMemberEvent"
	ApplyBlueprintEvent                AuditLogEvent = "ApplyBlueprintEvent"
	...
	CreateOrgDomainEvent               AuditLogEvent = "CreateOrgDomainEvent"
	CreateOtelIntegrationEvent         AuditLogEvent = "CreateOtelIntegrationEvent"
	CreatePostgresEvent                AuditLogEvent = "CreatePostgresEvent"
	CreatePrivateLinkEvent             AuditLogEvent = "CreatePrivateLinkEvent"
	...
	CreateWorkspaceEvent               AuditLogEvent = "CreateWorkspaceEvent"
	DeleteCronJobEvent                 AuditLogEvent = "DeleteCronJobEvent"
	DeleteEnvGroupEvent                AuditLogEvent = "DeleteEnvGroupEvent"
	DeleteEnvVarsEvent                 AuditLogEvent = "DeleteEnvVarsEvent"
	DeleteEnvironmentEvent             AuditLogEvent = "DeleteEnvironmentEvent"
	DeleteOrgDomainEvent               AuditLogEvent = "DeleteOrgDomainEvent"
	DeleteOtelIntegrationEvent         AuditLogEvent = "DeleteOtelIntegrationEvent"
	DeletePostgresEvent                AuditLogEvent = "DeletePostgresEvent"
	DeletePrivateLinkEvent             AuditLogEvent = "DeletePrivateLinkEvent"
	...
	DeleteWorkspaceEvent               AuditLogEvent = "DeleteWorkspaceEvent"
	...
	GrantOAuthAccessEvent              AuditLogEvent = "GrantOAuthAccessEvent"
	...
	LoginEvent                         AuditLogEvent = "LoginEvent"
	LogoutEvent                        AuditLogEvent = "LogoutEvent"
	MaintenanceModeEnabledEvent        AuditLogEvent = "MaintenanceModeEnabledEvent"
	MaintenanceModeURIUpdatedEvent     AuditLogEvent = "MaintenanceModeURIUpdatedEvent"
	MoveEnvironmentResourceEvent       AuditLogEvent = "MoveEnvironmentResourceEvent"
	ProvisionOrganizationSCIMToken     AuditLogEvent = "ProvisionOrganizationSCIMToken"
	RemoveOrgMemberEvent               AuditLogEvent = "RemoveOrgMemberEvent"
	RemoveUserFromTeamEvent            AuditLogEvent = "RemoveUserFromTeamEvent"
	RestoreDiskSnapshotEvent           AuditLogEvent = "RestoreDiskSnapshotEvent"
	ResumePostgresEvent                AuditLogEvent = "ResumePostgresEvent"
	ResumeServiceEvent                 AuditLogEvent = "ResumeServiceEvent"
	RevokeOAuthAccessEvent             AuditLogEvent = "RevokeOAuthAccessEvent"
	RevokeOrganizationSCIMToken        AuditLogEvent = "RevokeOrganizationSCIMToken"
	SignNDAEvent                       AuditLogEvent = "SignNDAEvent"
	StartShellEvent                    AuditLogEvent = "StartShellEvent"
	SuspendPostgresEvent               AuditLogEvent = "SuspendPostgresEvent"
...
// Valid indicates whether the value is a known member of the AuditLogEvent enum.
func (e AuditLogEvent) Valid() bool {
	switch e {
	case AcceptOrgInviteEvent:
		return true
	case AcceptTeamInviteEvent:
		return true
	case AddOrgMemberEvent:
		return true
	case ApplyBlueprintEvent:
		return true
	case ChangeEnvironmentProtectionEvent:
		return true
	case ChangeOrg2FAEnforcementEvent:
		return true
	case ChangeOrgAllowedLoginMethodsEvent:
		return true
	case ChangeOrgNameEvent:
		return true
	case ChangeOrgRoleEvent:
		return true
	case ChangeTeam2FAEnforcementEvent:
		return true
	case ChangeTeamAllowedLoginMethodsEvent:
		return true
	case ChangeTeamMemberRoleEvent:
		return true
	...
	case CreateCronJobEvent:
		return true
	case CreateEnvVarsEvent:
		return true
	case CreateEnvironmentEvent:
		return true
	case CreateOrgDomainEvent:
		return true
	case CreateOtelIntegrationEvent:
		return true
	case CreatePostgresEvent:
		return true
	case CreatePrivateLinkEvent:
		return true
	case CreateProjectEvent:
		return true
	case CreateRedisEvent:
		return true
	...
	case CreateServerEvent:
		return true
	case CreateWebhookEvent:
		return true
	case CreateWorkspaceEvent:
		return true
	case DeleteCronJobEvent:
		return true
	case DeleteEnvGroupEvent:
		return true
	case DeleteEnvVarsEvent:
		return true
	case DeleteEnvironmentEvent:
		return true
	case DeleteOrgDomainEvent:
		return true
	case DeleteOtelIntegrationEvent:
		return true
	case DeletePostgresEvent:
		return true
	case DeletePrivateLinkEvent:
		return true
	...
	case DeleteServerDiskEvent:
		return true
	case DeleteServerEvent:
		return true
	case DeleteWebhookEvent:
		return true
	case DeleteWorkspaceEvent:
		return true
	case DocumentDownloadEvent:
		return true
	case DownloadDatabaseBackupEvent:
		return true
	case EnableRedisInternalAuthEvent:
		return true
	case EndShellEvent:
		return true
	case GrantOAuthAccessEvent:
		return true
	case InviteToOrgEvent:
		return true
	case InviteToTeamEvent:
		return true
	case JoinTeamEvent:
		return true
	case LoginEvent:
	...
	case LogoutEvent:
		return true
	case MaintenanceModeEnabledEvent:
		return true
	case MaintenanceModeURIUpdatedEvent:
		return true
	case MoveEnvironmentResourceEvent:
		return true
	case ProvisionOrganizationSCIMToken:
		return true
	case RemoveOrgMemberEvent:
		return true
	case RemoveUserFromTeamEvent:
		return true
	case RestoreDiskSnapshotEvent:
		return true
	case ResumePostgresEvent:
		return true
	case ResumeServiceEvent:
		return true
	case RevokeOAuthAccessEvent:
		return true
	case RevokeOrganizationSCIMToken:
		return true
	case SignNDAEvent:
		return true
	case StartShellEvent:
		return true
	case SuspendPostgresEvent:
		return true
	case SuspendServiceEvent:
		return true
	case UpdateEnvVarsEvent:
		return true
	...
	case VerifyOrgDomainEvent:
		return true
	case ViewConnectionInfoEvent:
		return true
	case ViewEnvVarValuesEvent:
		return true
	default:
		return false
	}
...
const (
	AuditLogStatusError   AuditLogStatus = "error"
	AuditLogStatusSuccess AuditLogStatus = "success"
)

// Valid indicates whether the value is a known member of the AuditLogStatus enum.
func (e AuditLogStatus) Valid() bool {
	switch e {
	case AuditLogStatusError:
		return true
...
const (
	AuditLogActorTypeRestApi AuditLogActorType = "rest_api"
...
// Valid indicates whether the value is a known member of the AutoDeploy enum.
func (e AutoDeploy) Valid() bool {
	switch e {
	case AutoDeployNo:
		return true
	case AutoDeployYes:
...
// Valid indicates whether the value is a known member of the BuildPlan enum.
func (e BuildPlan) Valid() bool {
	switch e {
	case BuildPlanPerformance:
		return true
	case BuildPlanStarter:
		return true
	default:
		return false
	}
...
// Defines values for CacheProfile.
const (
	NoCache             CacheProfile = "no-cache"
	OriginControlled    CacheProfile = "origin-controlled"
	OriginControlledAll CacheProfile = "origin-controlled-all"
)

// Valid indicates whether the value is a known member of the CacheProfile enum.
func (e CacheProfile) Valid() bool {
	switch e {
	case NoCache:
		return true
	case OriginControlled:
		return true
	case OriginControlledAll:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the CustomDomainDomainType enum.
func (e CustomDomainDomainType) Valid() bool {
	switch e {
	case CustomDomainDomainTypeApex:
		return true
	case CustomDomainDomainTypeSubdomain:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the CustomDomainVerificationStatus enum.
func (e CustomDomainVerificationStatus) Valid() bool {
	switch e {
...
func (e DatabaseStatus) Valid() bool {
	switch e {
	case DatabaseStatusAvailable:
		return true
	case DatabaseStatusConfigRestart:
		return true
	case DatabaseStatusCreating:
		return true
	case DatabaseStatusMaintenanceInProgress:
		return true
	case DatabaseStatusMaintenanceScheduled:
		return true
	case DatabaseStatusRecoveryFailed:
		return true
	case DatabaseStatusRecoveryInProgress:
		return true
	case DatabaseStatusSuspended:
		return true
	case DatabaseStatusUnavailable:
		return true
	case DatabaseStatusUnknown:
		return true
	case DatabaseStatusUpdatingInstance:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DedicatedIPStatus enum.
func (e DedicatedIPStatus) Valid() bool {
	switch e {
	case CREATING:
		return true
	case DELETED:
...
// Valid indicates whether the value is a known member of the DeployTrigger enum.
func (e DeployTrigger) Valid() bool {
	switch e {
	case DeployTriggerApi:
		return true
	case DeployTriggerBlueprintSync:
		return true
	case DeployTriggerDeployHook:
		return true
	case DeployTriggerDeployedByRender:
		return true
	case DeployTriggerManual:
		return true
	case DeployTriggerNewCommit:
		return true
	case DeployTriggerOther:
		return true
	case DeployTriggerRollback:
		return true
	case DeployTriggerServiceResumed:
		return true
	case DeployTriggerServiceUpdated:
		return true
	default:
		return false
	}
...
func (e DeployStatus) Valid() bool {
	switch e {
	case DeployStatusBuildFailed:
		return true
	case DeployStatusBuildInProgress:
		return true
	case DeployStatusCanceled:
		return true
	case DeployStatusCreated:
		return true
	case DeployStatusDeactivated:
		return true
	case DeployStatusLive:
		return true
	case DeployStatusPreDeployFailed:
		return true
	case DeployStatusPreDeployInProgress:
		return true
	case DeployStatusQueued:
		return true
	case DeployStatusUpdateFailed:
		return true
	case DeployStatusUpdateInProgress:
		return true
	default:
		return false
	}
...
// Defines values for InternalRouting.
const (
	IpOnly InternalRouting = "ipOnly"
)

// Valid indicates whether the value is a known member of the InternalRouting enum.
func (e InternalRouting) Valid() bool {
	switch e {
	case IpOnly:
		return true
	default:
...
// Valid indicates whether the value is a known member of the KeyValuePlan enum.
func (e KeyValuePlan) Valid() bool {
	switch e {
	...
	case KeyValuePlanPro:
		return true
	case KeyValuePlanProPlus:
		return true
	case KeyValuePlanStandard:
		return true
	case KeyValuePlanStarter:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the MaxmemoryPolicy enum.
func (e MaxmemoryPolicy) Valid() bool {
	switch e {
	case AllkeysLfu:
		return true
	case AllkeysLru:
...
// Valid indicates whether the value is a known member of the NotifySetting enum.
func (e NotifySetting) Valid() bool {
	switch e {
	case Default:
		return true
	case Ignore:
...
func (e PaidPlan) Valid() bool {
	...
	case PaidPlanProMax:
		return true
	case PaidPlanProPlus:
		return true
	case PaidPlanProUltra:
		return true
	case PaidPlanStandard:
		return true
	case PaidPlanStarter:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PersistenceMode enum.
func (e PersistenceMode) Valid() bool {
	switch e {
	case PersistenceModeJournalSnapshot:
		return true
	case PersistenceModeOff:
		return true
...
func (e Plan) Valid() bool {
	...
	case PlanProPlus:
		return true
	case PlanProPlusLegacy:
		return true
	case PlanProUltra:
		return true
	case PlanStandard:
		return true
	case PlanStandardLegacy:
		return true
	case PlanStandardPlus:
		return true
	case PlanStandardPlusLegacy:
		return true
	case PlanStarter:
		return true
	case PlanStarterLegacy:
		return true
	case PlanStarterPlus:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PostgresSuspended enum.
func (e PostgresSuspended) Valid() bool {
	switch e {
	case PostgresSuspendedNotSuspended:
		return true
	case PostgresSuspendedSuspended:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PostgresDetailSuspended enum.
func (e PostgresDetailSuspended) Valid() bool {
	switch e {
	case PostgresDetailSuspendedNotSuspended:
		return true
	case PostgresDetailSuspendedSuspended:
		return true
	default:
		return false
	}
...
const (
	...
	N18 PostgresVersion = "18"
)

// Valid indicates whether the value is a known member of the PostgresVersion enum.
func (e PostgresVersion) Valid() bool {
	switch e {
	case N11:
		return true
	case N12:
...
// Valid indicates whether the value is a known member of the PreviewsGeneration enum.
func (e PreviewsGeneration) Valid() bool {
	switch e {
	case PreviewsGenerationAutomatic:
		return true
	case PreviewsGenerationManual:
		return true
	case PreviewsGenerationOff:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ProtectedStatus enum.
func (e ProtectedStatus) Valid() bool {
	switch e {
	case Protected:
		return true
	case Unprotected:
...
// Valid indicates whether the value is a known member of the PullRequestPreviewsEnabled enum.
func (e PullRequestPreviewsEnabled) Valid() bool {
	switch e {
	case PullRequestPreviewsEnabledNo:
		return true
	case PullRequestPreviewsEnabledYes:
		return true
	default:
		return false
	}
...
func (e RedisPlan) Valid() bool {
	...
	case RedisPlanPro:
		return true
	case RedisPlanProPlus:
		return true
	case RedisPlanStandard:
		return true
	case RedisPlanStarter:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the RegistryCredentialRegistry enum.
func (e RegistryCredentialRegistry) Valid() bool {
	switch e {
	case AWSECR:
		return true
	case DOCKER:
...
// Valid indicates whether the value is a known member of the RenderSubdomainPolicy enum.
func (e RenderSubdomainPolicy) Valid() bool {
	switch e {
	case Disabled:
		return true
	case Enabled:
...
// Valid indicates whether the value is a known member of the ServerPortProtocol enum.
func (e ServerPortProtocol) Valid() bool {
	switch e {
	case TCP:
		return true
	case UDP:
...
// Valid indicates whether the value is a known member of the ServiceSuspended enum.
func (e ServiceSuspended) Valid() bool {
	switch e {
	case ServiceSuspendedNotSuspended:
		return true
	case ServiceSuspendedSuspended:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ServiceEnv enum.
func (e ServiceEnv) Valid() bool {
	switch e {
	case ServiceEnvDocker:
		return true
	case ServiceEnvElixir:
		return true
	case ServiceEnvGo:
		return true
	case ServiceEnvImage:
		return true
	case ServiceEnvNode:
		return true
	case ServiceEnvPython:
		return true
	case ServiceEnvRuby:
		return true
	case ServiceEnvRust:
...
func (e ServiceRuntime) Valid() bool {
	switch e {
	case ServiceRuntimeDocker:
		return true
	case ServiceRuntimeElixir:
		return true
	case ServiceRuntimeGo:
		return true
	case ServiceRuntimeImage:
		return true
	case ServiceRuntimeNode:
		return true
	case ServiceRuntimePython:
		return true
	case ServiceRuntimeRuby:
		return true
	case ServiceRuntimeRust:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ServiceTypeShort enum.
func (e ServiceTypeShort) Valid() bool {
	switch e {
	case Cron:
		return true
	case Pserv:
...
// Valid indicates whether the value is a known member of the SuspenderType enum.
func (e SuspenderType) Valid() bool {
	switch e {
	case SuspenderTypeAdmin:
		return true
	case SuspenderTypeBilling:
		return true
	case SuspenderTypeHipaaEnablement:
		return true
	case SuspenderTypeParentService:
		return true
	case SuspenderTypeStuckCrashlooping:
		return true
	case SuspenderTypeUnknown:
		return true
	case SuspenderTypeUser:
		return true
	default:
		return false
	}
...
const (
	...
	DEVELOPER            TeamMemberRole = "DEVELOPER"
	WORKSPACEBILLING     TeamMemberRole = "WORKSPACE_BILLING"
	WORKSPACECONTRIBUTOR TeamMemberRole = "WORKSPACE_CONTRIBUTOR"
	WORKSPACEVIEWER      TeamMemberRole = "WORKSPACE_VIEWER"
)
...
// Valid indicates whether the value is a known member of the ListLogsValuesParamsLabel enum.
func (e ListLogsValuesParamsLabel) Valid() bool {
	switch e {
	case Host:
		return true
	case Instance:
...
// Defines values for GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource.
const (
	Http        GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource = "http"
	Nat         GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource = "nat"
	Privatelink GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource = "privatelink"
	Total       GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource = "total"
	Websocket   GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource = "websocket"
)

// Valid indicates whether the value is a known member of the GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource enum.
func (e GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource) Valid() bool {
	switch e {
	case Http:
		return true
	case Nat:
...
// Valid indicates whether the value is a known member of the ListPostgresParamsSuspended enum.
func (e ListPostgresParamsSuspended) Valid() bool {
	switch e {
	case ListPostgresParamsSuspendedNotSuspended:
		return true
	case ListPostgresParamsSuspendedSuspended:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the StreamSandboxLogsParamsAccept enum.
func (e StreamSandboxLogsParamsAccept) Valid() bool {
	switch e {
	case StreamSandboxLogsParamsAcceptTexteventStream:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ListServicesParamsSuspended enum.
func (e ListServicesParamsSuspended) Valid() bool {
	switch e {
	case ListServicesParamsSuspendedNotSuspended:
		return true
	case ListServicesParamsSuspendedSuspended:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ListCustomDomainsParamsDomainType enum.
func (e ListCustomDomainsParamsDomainType) Valid() bool {
	switch e {
	case ListCustomDomainsParamsDomainTypeApex:
		return true
	case ListCustomDomainsParamsDomainTypeSubdomain:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ListCustomDomainsParamsVerificationStatus enum.
func (e ListCustomDomainsParamsVerificationStatus) Valid() bool {
	switch e {
	case ListCustomDomainsParamsVerificationStatusUnverified:
		return true
	case ListCustomDomainsParamsVerificationStatusVerified:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the CreateDeployJSONBodyClearCache enum.
func (e CreateDeployJSONBodyClearCache) Valid() bool {
	switch e {
	case Clear:
		return true
	case DoNotClear:
...
// Valid indicates whether the value is a known member of the ListRoutesParamsType enum.
func (e ListRoutesParamsType) Valid() bool {
	switch e {
	case ListRoutesParamsTypeRedirect:
		return true
	case ListRoutesParamsTypeRewrite:
		return true
	default:
		return false
	}
...
type AuditLog struct {
	...
	// Metadata Additional context information about the event
	//
	// Example: {"field":"env_vars","service":"srv-123456789"}
...
// AuditLogEvent The type of event that occurred
//
// Example: CreateServerEvent
type AuditLogEvent string

// AuditLogStatus The status of the event
//
// Example: success
...
type AuditLogActor struct {
	// Email Email address of the actor (if applicable)
	//
	// Example: user@example.com
	Email *string `json:"email,omitempty"`

	// Id Unique identifier of the actor (if applicable)
	//
	// Example: usr-123456789
	Id *string `json:"id,omitempty"`

	// Type The type of actor that performed the action
	//
	// Example: user
	Type AuditLogActorType `json:"type"`
}

// AuditLogActorType The type of actor that performed the action
//
// Example: user
type AuditLogActorType string

// AuditLogWithCursor defines model for auditLogWithCursor.
...
type BackgroundWorkerDetails struct {
	...
	Disk        *externalRef4.Disk              `json:"disk,omitempty"`
...
type Cache struct {
	Profile CacheProfile `json:"profile"`
}

// CacheProfile defines model for Cache.Profile.
type CacheProfile string
...
type DedicatedIP struct {
	// CreatedAt Time the dedicated IP set was created.
	CreatedAt time.Time `json:"createdAt"`

	// Description Free-form description for this dedicated IP set.
	Description string `json:"description"`

	// EnvironmentIds Environments this dedicated IP set applies to. If empty, it applies to all services in the workspace within its region.
	EnvironmentIds []string `json:"environmentIds"`

	// Id Unique identifier for this dedicated IP set.
	Id string `json:"id"`

	// Ips The IPv4 addresses assigned to this dedicated IP set.
	Ips []string `json:"ips"`

	// Name Descriptive name for this dedicated IP set.
	Name string `json:"name"`

	// OwnerId The ID of the workspace that owns this dedicated IP set.
	OwnerId string `json:"ownerId"`

	// Region Defaults to "oregon"
	Region Region `json:"region"`

	// Status Current status of a dedicated IP set.
	Status DedicatedIPStatus `json:"status"`

	// UpdatedAt Time the dedicated IP set was last updated.
...
// DedicatedIPPOST Input for creating a dedicated IP set.
type DedicatedIPPOST struct {
	// Description Free-form description for the dedicated IP set.
	Description *string `json:"description,omitempty"`

	// EnvironmentIds Environments to scope the dedicated IP set to. If omitted or empty, it applies to all services in the workspace within its region.
	EnvironmentIds *[]string `json:"environmentIds,omitempty"`

	// Name Name for the dedicated IP set.
	Name string `json:"name"`

	// OwnerId The ID of the workspace that will own this dedicated IP set.
	OwnerId string `json:"ownerId"`
...
// DedicatedIPStatus Current status of a dedicated IP set.
...
type DiskWithCursor struct {
	Cursor Cursor                   `json:"cursor"`
	Disk   externalRef4.DiskDetails `json:"disk"`
}
...
type EnvGroupPOSTInput struct {
	EnvVars       externalRef5.EnvVarInputArray   `json:"envVars"`
	EnvironmentId *string                         `json:"environmentId,omitempty"`
	Name          string                          `json:"name"`
	OwnerId       string                          `json:"ownerId"`
...
type Error struct {
	// Code A stable, machine-readable identifier present on specific errors that clients can handle specially. Each endpoint documents the codes it can return. The errorCode schema lists the full vocabulary of codes.
...
type ExecutionWithCursor struct {
	...
	Execution externalRef15.Execution `json:"execution"`
}
...
// InternalRouting How requests from other services in the same workspace are routed to this service's instances. When unset, Render's standard routing is used. `ipOnly` routes requests directly to individual instance IPs. Only available to workspaces that Render has granted access. Can only be set when creating a service.
type InternalRouting string

// JobWithCursor defines model for jobWithCursor.
type JobWithCursor struct {
	Cursor Cursor           `json:"cursor"`
	Job    externalRef9.Job `json:"job"`
}
...
type KeyValueDetail struct {
	...
	// IpAllowList The IP allow list for the Key Value instance
	IpAllowList []CidrBlockAndDescription     `json:"ipAllowList"`
	Maintenance *externalRef11.MaintenanceRun `json:"maintenance,omitempty"`
...
type NotificationOverrideWithCursor struct {
	Cursor   Cursor                             `json:"cursor"`
	Override externalRef13.NotificationOverride `json:"override"`
}
...
type Postgres struct {
	...
	Name                    string                      `json:"name"`
	Owner                   Owner                       `json:"owner"`
	Plan                    externalRef14.PostgresPlans `json:"plan"`
...
type PostgresPATCHInput struct {
	...
	Name                   *string                      `json:"name,omitempty"`
	ParameterOverrides     *PostgresParameterOverrides  `json:"parameterOverrides,omitempty"`
	Plan                   *externalRef14.PostgresPlans `json:"plan,omitempty"`
...
type SandboxSnapshotWithCursor struct {
	Cursor   Cursor                        `json:"cursor"`
	Snapshot externalRef15.SandboxSnapshot `json:"snapshot"`
}

// SandboxWithCursor A sandbox with a cursor
type SandboxWithCursor struct {
	Cursor  Cursor                `json:"cursor"`
	Sandbox externalRef15.Sandbox `json:"sandbox"`
}
...
type Service struct {
	...
	// Repo Example: https://github.com/render-examples/flask-hello-world
...
type TaskRunWithCursor struct {
	Cursor  Cursor                `json:"cursor"`
	TaskRun externalRef18.TaskRun `json:"taskRun"`
}

// TaskWithCursor defines model for taskWithCursor.
type TaskWithCursor struct {
	Cursor Cursor             `json:"cursor"`
	Task   externalRef18.Task `json:"task"`
}
...
type TeamMember struct {
	...
	// Role The member's workspace role. Values are always returned in uppercase.
	//
	// Example: DEVELOPER
...
// TeamMemberRole The member's workspace role. Values are always returned in uppercase.
//
// Example: DEVELOPER
...
type WebServiceDetails struct {
	...
	// InternalRouting How requests from other services in the same workspace are routed to this service's instances. When unset, Render's standard routing is used. `ipOnly` routes requests directly to individual instance IPs. Only available to workspaces that Render has granted access. Can only be set when creating a service.
	InternalRouting *InternalRouting           `json:"internalRouting,omitempty"`
	IpAllowList     *[]CidrBlockAndDescription `json:"ipAllowList,omitempty"`
...
// EndTimeParam Example: 2021-06-17T08:30:30Z
...
// RegionPathParam Defaults to "oregon"
type RegionPathParam = Region
...
// StartTimeParam Example: 2021-06-17T08:15:30Z
...
// UserIdPathParam Example: usr-5k6m7n8p9q0r1s2t3u4v
type UserIdPathParam = string
...
// N413RequestEntityTooLarge defines model for 413RequestEntityTooLarge.
type N413RequestEntityTooLarge = Error
...
type Logs200Response struct {
	// HasMore True if there are more logs to fetch
	HasMore bool                `json:"hasMore"`
	Logs    []externalRef10.Log `json:"logs"`
...
type UpdateSecretFilesForBuildSourceJSONBody = []externalRef5.SecretFileInput
...
type ListDisksParams struct {
	...
	DiskId *externalRef4.DiskIdQuery `form:"diskId,omitempty" json:"diskId,omitempty"`
...
type ListLogsParams struct {
	...
	Direction *externalRef10.DirectionParam `form:"direction,omitempty" json:"direction,omitempty"`
	...
	Resource externalRef10.LogFilterResource `form:"resource" json:"resource"`

	// Instance Filter logs by the instance they were emitted from. An instance is the id of a specific running server.
	Instance *externalRef10.LogFilterInstance `form:"instance,omitempty" json:"instance,omitempty"`
	...
	Host *externalRef10.LogFilterHost `form:"host,omitempty" json:"host,omitempty"`
	...
	StatusCode *externalRef10.LogFilterStatusCode `form:"statusCode,omitempty" json:"statusCode,omitempty"`
	...
	Method *externalRef10.LogFilterMethod `form:"method,omitempty" json:"method,omitempty"`

	// Task Filter logs by their task(s)
	Task *externalRef10.LogFilterTask `form:"task,omitempty" json:"task,omitempty"`

	// TaskRun Filter logs by their task run id(s)
	TaskRun *externalRef10.LogFilterTaskRun `form:"taskRun,omitempty" json:"taskRun,omitempty"`

	// Sandbox Filter logs by sandbox ID.
	Sandbox *externalRef10.LogFilterSandbox `form:"sandbox,omitempty" json:"sandbox,omitempty"`
	...
	Level *externalRef10.LogFilterLevel `form:"level,omitempty" json:"level,omitempty"`
	...
	Type *externalRef10.LogFilterType `form:"type,omitempty" json:"type,omitempty"`
	...
	Text *externalRef10.LogFilterText `form:"text,omitempty" json:"text,omitempty"`
	...
	Path *externalRef10.LogFilterPath `form:"path,omitempty" json:"path,omitempty"`
...
type ListResourceLogStreamsParams struct {
	...
	LogStreamId *externalRef10.LogStreamIdFilter `form:"logStreamId,omitempty" json:"logStreamId,omitempty"`
	...
	Setting *externalRef10.LogStreamSettingFilter `form:"setting,omitempty" json:"setting,omitempty"`
...
type ListMaintenanceParams struct {
	ResourceId *externalRef11.MaintenanceResourcesParam `form:"resourceId,omitempty" json:"resourceId,omitempty"`

	// OwnerId The ID of the workspaces to return resources for
	OwnerId *OwnerIdParam                        `form:"ownerId,omitempty" json:"ownerId,omitempty"`
	State   *externalRef11.MaintenanceStateParam `form:"state,omitempty" json:"state,omitempty"`
}
...
type GetActiveConnectionsParams struct {
	...
	ResolutionSeconds *externalRef12.ResolutionParam `form:"resolutionSeconds,omitempty" json:"resolutionSeconds,omitempty"`
	...
	Resource *externalRef12.DatastoreResourceQueryParam `form:"resource,omitempty" json:"resource,omitempty"`
}
...
type GetBandwidthParams struct {
	...
	Resource *externalRef12.ServiceResourceQueryParam `form:"resource,omitempty" json:"resource,omitempty"`

	// Service This parameter is deprecated. Please use `resource` instead
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Service *externalRef12.ServiceQueryParam `form:"service,omitempty" json:"service,omitempty"`
}

// GetBandwidthSourcesParams defines parameters for GetBandwidthSources.
type GetBandwidthSourcesParams struct {
	// StartTime Epoch/Unix timestamp of start of time range to return. Defaults to `now() - 1 hour`.
	StartTime *StartTimeParam `form:"startTime,omitempty" json:"startTime,omitempty"`
...
// GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource defines parameters for GetBandwidthSources.
type GetBandwidthSources200JSONResponseBodyDataLabelsTrafficSource string
...
type GetCpuParams struct {
	...
	Resource *externalRef12.ResourceQueryParam `form:"resource,omitempty" json:"resource,omitempty"`
	...
	Instance *externalRef12.InstanceQueryParam `form:"instance,omitempty" json:"instance,omitempty"`

	// AggregationMethod The aggregation method to apply to multiple time series
	AggregationMethod *externalRef12.ApplicationMetricAggregationMethod `form:"aggregationMethod,omitempty" json:"aggregationMethod,omitempty"`
}
...
type ListHttpFilterValuesParams struct {
	...
	Host *externalRef12.HostQueryParam `form:"host,omitempty" json:"host,omitempty"`
	...
	StatusCode *externalRef12.HttpStatusCode `form:"statusCode,omitempty" json:"statusCode,omitempty"`
}
...
type ListPathFilterValuesParams struct {
	...
	Path *externalRef12.PathQueryParam `form:"path,omitempty" json:"path,omitempty"`
}
...
type GetHttpLatencyParams struct {
	...
	Quantile *externalRef12.Quantile `form:"quantile,omitempty" json:"quantile,omitempty"`
}
...
type GetHttpRequestsParams struct {
	...
	AggregateBy *externalRef12.HttpAggregateBy `form:"aggregateBy,omitempty" json:"aggregateBy,omitempty"`
}
...
type GetReplicationLagParams struct {
	...
	Resource *externalRef12.PostgresResourceQueryParam `form:"resource,omitempty" json:"resource,omitempty"`
}
...
type GetTaskRunsCompletedParams struct {
	...
	Resource *externalRef12.TaskResourceQueryParam `form:"resource,omitempty" json:"resource,omitempty"`

	// State The state of task runs to filter to. When multiple state query params are provided, they are ORed together
	State *externalRef12.TaskStateQueryParam `form:"state,omitempty" json:"state,omitempty"`

	// AggregateBy The field to aggregate by
	AggregateBy *externalRef12.TaskAggregateBy `form:"aggregateBy,omitempty" json:"aggregateBy,omitempty"`
}
...
// ListOrganizationAuditLogsParams defines parameters for ListOrganizationAuditLogs.
type ListOrganizationAuditLogsParams struct {
	...
	Limit *AuditLogLimitParam `form:"limit,omitempty" json:"limit,omitempty"`
}
...
// ListOwnerAuditLogsParams defines parameters for ListOwnerAuditLogs.
type ListOwnerAuditLogsParams struct {
	// StartTime Start time for filtering audit logs (ISO 8601 format)
	StartTime *time.Time `form:"startTime,omitempty" json:"startTime,omitempty"`
...
type ListSandboxSnapshotsParams struct {
	...
	Status *[]externalRef15.SandboxSnapshotStatus `form:"status,omitempty" json:"status,omitempty"`
}
...
type DeleteSandboxSnapshotParams struct {
	...
	// supplied.
	OwnerId *externalRef15.OwnerIdGroupScoped `form:"ownerId,omitempty" json:"ownerId,omitempty"`
}
...
type ListSandboxesParams struct {
	...
	Status *[]externalRef15.SandboxStatus `form:"status,omitempty" json:"status,omitempty"`
}
...
type RetrieveSandboxParams struct {
	...
	OwnerId *externalRef15.OwnerId `form:"ownerId,omitempty" json:"ownerId,omitempty"`
}
...
type ListJobParams struct {
	...
	Status *[]externalRef9.JobStatus `form:"status,omitempty" json:"status,omitempty"`
...
type UpdateSecretFilesForServiceJSONBody = []externalRef5.SecretFileInput
...
type ListTaskRunsParams struct {
	...
	TaskSlug *externalRef18.TaskSlugFilterParam `form:"taskSlug,omitempty" json:"taskSlug,omitempty"`

	// RootTaskRunId An array of root task run IDs to filter on
	RootTaskRunId *externalRef18.RootTaskRunIDFilterParam `form:"rootTaskRunId,omitempty" json:"rootTaskRunId,omitempty"`

	// OwnerId The ID of the workspaces to return resources for
	OwnerId *OwnerIdParam `form:"ownerId,omitempty" json:"ownerId,omitempty"`

	// WorkflowVersionId An array of workflow version IDs
	WorkflowVersionId *externalRef18.WorkflowVersionIDFilterParam `form:"workflowVersionId,omitempty" json:"workflowVersionId,omitempty"`

	// WorkflowId An array of workflow IDs
	WorkflowId *externalRef18.WorkflowIDFilterParam `form:"workflowId,omitempty" json:"workflowId,omitempty"`
}
...
type ListWebhookEventsParams struct {
	...
	SentBefore *externalRef17.SentBeforeParam `form:"sentBefore,omitempty" json:"sentBefore,omitempty"`

	// SentAfter Filter for resources sent after a certain time (specified as an ISO 8601 timestamp)
	SentAfter *externalRef17.SentAfterParam `form:"sentAfter,omitempty" json:"sentAfter,omitempty"`
...
type UpdateEnvVarsForBuildSourceJSONRequestBody = externalRef5.EnvVarInputArray
...
type AddDiskJSONRequestBody = externalRef4.DiskPOST

// UpdateDiskJSONRequestBody defines body for UpdateDisk for application/json ContentType.
type UpdateDiskJSONRequestBody = externalRef4.DiskPATCH
...
type PatchServiceNotificationOverridesJSONRequestBody = externalRef13.NotificationServiceOverridePATCH
...
type PatchOwnerNotificationSettingsJSONRequestBody = externalRef13.NotificationSettingPATCH

// PutObjectJSONRequestBody defines body for PutObject for application/json ContentType.
type PutObjectJSONRequestBody = externalRef16.PutObjectInput
...
type UpdateEnvVarsForServiceJSONRequestBody = externalRef5.EnvVarInputArray
...
type CreateTaskJSONRequestBody = externalRef18.RunTask

// CreateWebhookJSONRequestBody defines body for CreateWebhook for application/json ContentType.
type CreateWebhookJSONRequestBody = externalRef17.WebhookPOSTInput

// UpdateWebhookJSONRequestBody defines body for UpdateWebhook for application/json ContentType.
type UpdateWebhookJSONRequestBody = externalRef17.WebhookPATCHInput

// CreateWorkflowJSONRequestBody defines body for CreateWorkflow for application/json ContentType.
type CreateWorkflowJSONRequestBody = externalRef18.WorkflowCreate

// UpdateWorkflowJSONRequestBody defines body for UpdateWorkflow for application/json ContentType.
type UpdateWorkflowJSONRequestBody = externalRef18.WorkflowUpdate

// CreateWorkflowVersionJSONRequestBody defines body for CreateWorkflowVersion for application/json ContentType.
type CreateWorkflowVersionJSONRequestBody = externalRef18.CreateVersion
...
// AsExternalRef8ServiceEventType returns the union data inside the EventTypeParam as a externalRef8.ServiceEventType
func (t EventTypeParam) AsExternalRef8ServiceEventType() (externalRef8.ServiceEventType, error) {
	var body externalRef8.ServiceEventType
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromExternalRef8ServiceEventType overwrites any union data inside the EventTypeParam as the provided externalRef8.ServiceEventType
func (t *EventTypeParam) FromExternalRef8ServiceEventType(v externalRef8.ServiceEventType) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeExternalRef8ServiceEventType performs a merge with any union data inside the EventTypeParam, using the provided externalRef8.ServiceEventType
func (t *EventTypeParam) MergeExternalRef8ServiceEventType(v externalRef8.ServiceEventType) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
