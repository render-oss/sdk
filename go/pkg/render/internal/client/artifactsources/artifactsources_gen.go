...
const (
	...
	BuildRuntimeElixir BuildRuntime = "elixir"
	BuildRuntimeGo     BuildRuntime = "go"
	BuildRuntimeNode   BuildRuntime = "node"
	BuildRuntimePython BuildRuntime = "python"
	BuildRuntimeRuby   BuildRuntime = "ruby"
	BuildRuntimeRust   BuildRuntime = "rust"
)
...
func (e BuildRuntime) Valid() bool {
	...
	case BuildRuntimeDocker:
		return true
	case BuildRuntimeElixir:
		return true
	case BuildRuntimeGo:
		return true
	case BuildRuntimeNode:
		return true
	case BuildRuntimePython:
		return true
	case BuildRuntimeRuby:
		return true
	case BuildRuntimeRust:
		return true
	default:
		return false
	}
...
type ArtifactSource struct {
	...
	// ServiceLinks Services currently linked to this artifact source.
	ServiceLinks []ArtifactSourceServiceLink `json:"serviceLinks"`
	UpdatedAt    time.Time                   `json:"updatedAt"`
}
...
type ArtifactSourcePOSTInput struct {
	// EnvGroupIds IDs of env groups to link to the artifact source. Only valid for `git` sources; env groups must belong to the same workspace and must not be scoped to an environment.
	...
	// SecretFiles Secret files for the artifact source's build. Only valid for `git` sources.
	SecretFiles *[]externalRef5.SecretFileInput `json:"secretFiles,omitempty"`
	ServiceIds  *[]string                       `json:"serviceIds,omitempty"`
}

// ArtifactSourceServiceLink defines model for artifactSourceServiceLink.
type ArtifactSourceServiceLink struct {
	Id   string `json:"id"`
	Name string `json:"name"`
}
