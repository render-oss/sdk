...
// Valid indicates whether the value is a known member of the MaintenanceState enum.
func (e MaintenanceState) Valid() bool {
	switch e {
	case Cancelled:
		return true
	case Failed:
...
type MaintenanceRun struct {
	// Id Example: mrn-cph1rs3idesc73a2b2mg
...
// MaintenanceRunId Example: mrn-cph1rs3idesc73a2b2mg
...
// MaintenanceRunParam Example: mrn-cph1rs3idesc73a2b2mg
