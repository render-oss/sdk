...
// Valid indicates whether the value is a known member of the FilterApplicationValuesCollectionFilter enum.
func (e FilterApplicationValuesCollectionFilter) Valid() bool {
	switch e {
	case Instance:
		return true
	default:
...
// Valid indicates whether the value is a known member of the FilterHTTPValuesCollectionFilter enum.
func (e FilterHTTPValuesCollectionFilter) Valid() bool {
	switch e {
	case FilterHTTPValuesCollectionFilterHost:
		return true
	case FilterHTTPValuesCollectionFilterStatusCode:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the OtelProviderType enum.
func (e OtelProviderType) Valid() bool {
	switch e {
	case BETTERSTACK:
		return true
	case CUSTOM:
...
// Valid indicates whether the value is a known member of the ApplicationMetricAggregationMethod enum.
func (e ApplicationMetricAggregationMethod) Valid() bool {
	switch e {
	case AVG:
		return true
	case MAX:
...
// Valid indicates whether the value is a known member of the HttpAggregateBy enum.
func (e HttpAggregateBy) Valid() bool {
	switch e {
	case HttpAggregateByHost:
		return true
	case HttpAggregateByStatusCode:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TaskAggregateBy enum.
func (e TaskAggregateBy) Valid() bool {
	switch e {
	case State:
		return true
	default:
...
// Valid indicates whether the value is a known member of the TaskStateQueryParam enum.
func (e TaskStateQueryParam) Valid() bool {
	switch e {
	case Failed:
		return true
	case Succeeded:
...
type TimeSeriesValue struct {
	// Timestamp Example: 2021-06-17T08:15:30Z
